  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5 reveal reveal-up heading-underline'>Why choose BIU ?</h2>
            <div className='row g-4'>
                <div className='col-lg-4 reveal reveal-up delay-1'>
                    <Card className='d-flex align-items-center border-0 h-100 card-cool'>
                        <div className='mt-3 icon-float'>
                        ...
                        <Card.Body>
                            <Card.Title className='text-center text-capitalize mb-3'>
                                Many trophies received
                            </Card.Title>
                            <Card.Text className='text-center'></Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4 reveal reveal-up delay-2'>
                    <Card className='d-flex align-items-center border-0 h-100 card-cool'>
                        <div className='mt-3 icon-float delay-icon-2'>
                ...
                <div className='col-lg-4 reveal reveal-up delay-3'>
                    <Card className='d-flex align-items-center border-0 h-100 card-cool'>
                        <div className='mt-3 icon-float delay-icon-3'>
                        ...
                        <Card.Body>
                            <Card.Title className='text-center text-capitalize mb-3'>
                                3 locations in Cambodia
                            </Card.Title>
                            <Card.Text className='text-center'>
                                Toul Sleng Campus - Chom Chav - Prey Sor
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
